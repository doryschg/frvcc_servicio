...
public class VentaRegistrarPostController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;

	public VentaRegistrarPostController(QueryBus queryBus, CommandBus commandBus) {
	...
	public ResponseEntity<ResultadoGenericoDto<String>> registrarCompras(@RequestBody Request request)
		...
		dispatch(RegistroVentaCommand.newRegistroVentaCommand().id(request.venta.getId())
				...
				.usuarioRegistro(usuarioId()).nombreCliente(request.venta.getRazonSocial())
