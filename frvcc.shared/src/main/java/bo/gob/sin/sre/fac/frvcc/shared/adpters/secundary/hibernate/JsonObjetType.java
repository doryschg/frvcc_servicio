...
public class JsonObjetType implements UserType, DynamicParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        if (value != null && !value.equals("")) {
            try {
                result = OBJECT_MAPPER.readValue(value, classType);
            } catch (IOException e) {
                return result;
            }
        }
    ...
    public Object deepCopy(Object value) throws HibernateException {
        if (value == null) {
            return null;
        } else if (valueType.isJavaLangObject()) {
            return value;
        }
        return null;
    ...
    public void setParameterValues(Properties parameters) {
        try {
            Class<?> entityClass = Class.forName(parameters.getProperty("objet_of"));
            valueType =OBJECT_MAPPER.constructType(entityClass.getGenericSuperclass());
//            OBJECT_MAPPER.getTypeFactory().constructSimpleType(entityClass, (JavaType[]) entityClass.getTypeParameters())
