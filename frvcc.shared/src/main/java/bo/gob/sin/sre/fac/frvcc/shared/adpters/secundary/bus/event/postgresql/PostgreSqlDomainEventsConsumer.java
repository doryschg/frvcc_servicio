...
import bo.gob.sin.sre.fac.frvcc.shared.adpters.secundary.bus.event.spring.SpringApplicationEventBus;
...
public class PostgreSqlDomainEventsConsumer {
    ...
    public PostgreSqlDomainEventsConsumer(
        @Qualifier("misfacturas-session-factory") SessionFactory sessionFactory,
    ...
    private void executeSubscribers(
        ...
        Object domainEvent = fromPrimitivesMethod.invoke(
            ...
            id,
            Utils.localDateTimeToString(occurredOn)
        );
