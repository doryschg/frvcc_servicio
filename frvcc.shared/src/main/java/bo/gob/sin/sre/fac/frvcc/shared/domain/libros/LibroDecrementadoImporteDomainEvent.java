...
public final class LibroDecrementadoImporteDomainEvent extends DomainEvent {
	...
	public LibroDecrementadoImporteDomainEvent() {
	...
	public LibroDecrementadoImporteDomainEvent(String aggregateId, BigDecimal totalCompras, Integer cantidadCompras,
			Long usuarioUltimaModificacion, Integer periodoMes, Integer periodoAnio, String nombreLibro,
			String compraId) {
		super(aggregateId);
	...
	public LibroDecrementadoImporteDomainEvent(String aggregateId, String eventId, String occurredOn,
			BigDecimal totalCompras, Integer cantidadCompras, Long usuarioUltimaModificacion, Integer periodoMes,
			Integer periodoAnio, String nombreLibro, String compraId) {
	...
	public String eventName() {
		return "libro.decrementado_importe";
	}
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new LibroDecrementadoImporteDomainEvent(aggregateId, eventId, occurredOn,
