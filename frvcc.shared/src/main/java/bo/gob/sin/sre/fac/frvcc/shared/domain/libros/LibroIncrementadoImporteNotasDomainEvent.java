...
public final class LibroIncrementadoImporteNotasDomainEvent extends DomainEvent {
    ...
    public LibroIncrementadoImporteNotasDomainEvent(){
    ...
    public LibroIncrementadoImporteNotasDomainEvent(String aggregateId, BigDecimal totalCompras,
    ...
    public LibroIncrementadoImporteNotasDomainEvent(String aggregateId, String eventId,
    ...
    public String eventName() {
        return "libro.incrementar_importe_notas";
    }
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new LibroIncrementadoImporteNotasDomainEvent(aggregateId, eventId, occurredOn,
