...
public class JsonListType implements UserType, DynamicParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        String value  = rs.getString(names[0])!=null?rs.getString(names[0]).replace("\"value\"", "").replace("{:", "").replace("}", ""): null;
        Object result = null;
        if (valueType == null) {
    ...
    public void setParameterValues(Properties parameters) {
        try {
            ...
            valueType = OBJECT_MAPPER.getTypeFactory().constructCollectionType(List.class, entityClass);
