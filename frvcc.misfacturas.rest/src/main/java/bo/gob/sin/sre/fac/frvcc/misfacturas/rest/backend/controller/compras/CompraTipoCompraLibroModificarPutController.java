...
import bo.gob.sin.sre.fac.frvcc.misfacturas.adapters.primary.compras.modificar_tipo_compra_libro.ModificarLibroTipoCompraCommand;
...
public final class CompraTipoCompraLibroModificarPutController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public CompraTipoCompraLibroModificarPutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
    }

    @PutMapping(value = "/compra/tipoCompra/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id,
        ...
        dispatch(ModificarLibroTipoCompraCommand.newModificarCompraCommand()
                .id(id)
