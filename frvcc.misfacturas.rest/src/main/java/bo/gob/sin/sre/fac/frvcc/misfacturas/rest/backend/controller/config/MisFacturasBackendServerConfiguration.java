package bo.gob.sin.sre.fac.frvcc.misfacturas.rest.backend.controller.config;
...
@Configuration
public class MisFacturasBackendServerConfiguration {
    private final RequestMappingHandlerMapping mapping;
    private final MensajeAplicacionPort mensajeAplicacionPort;

    public MisFacturasBackendServerConfiguration(RequestMappingHandlerMapping mapping, MensajeAplicacionPort mensajeAplicacionPort) {
