...
import bo.gob.sin.sre.fac.frvcc.misfacturas.adapters.primary.compras.eliminar.EliminarCompraCommand;
...
public class FormularioDeleteController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public FormularioDeleteController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
    }

    @DeleteMapping(value = "/formulario/eliminar/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id) throws CommandNotRegisteredError, CommandHandlerExecutionError {
         dispatch(new EliminarFormularioCommand(id,usuarioId()));
