package bo.gob.sin.sre.fac.frvcc.misfacturas.libros.service.libros.seleccionar_compras_notas;
...
import bo.gob.sin.sre.fac.frvcc.misfacturas.libros.use.ports.primary.libros.seleccionar_compras_notas.ILibroSeleccionarComprasNotas;
...
@Service
public class LibroSeleccionarComprasNotas  implements ILibroSeleccionarComprasNotas {
	private static final Logger LOG= LoggerFactory.getLogger(LibroSeleccionarComprasNotas.class);
    private final LibroRepository repository;
    private final EventBus eventBus;
    private final QueryBus queryBus;
    private final LibroValidador validador;
    
   public LibroSeleccionarComprasNotas(LibroRepository repository, EventBus eventBus,
    ...
    public void incrementarImporteNotas(LibroId pLibroId,LibroUsuarioUltimaModificacion pUsuarioUltimaModificacion
       ...
       for (String idCompra : pListaIdsCompras) {
    	   ...
    	   try {
			CompraNotaResponse compraNotaResponse = queryBus.ask(new FindCompraNotaQuery(idCompra));
			CompraNotaResponseGenerico compraNota=compraNotaResponse.getCompraNotaResponse();
			libro.incrementoImporteNotas(compraNota.getImporteTotalNota(), compraNota.getCreditoFiscalNota(),
					pUsuarioUltimaModificacion, new CompraNotaId(compraNota.getId()));
