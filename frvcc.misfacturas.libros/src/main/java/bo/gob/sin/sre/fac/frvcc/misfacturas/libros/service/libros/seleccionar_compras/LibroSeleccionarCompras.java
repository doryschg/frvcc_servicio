package bo.gob.sin.sre.fac.frvcc.misfacturas.libros.service.libros.seleccionar_compras;
...
import bo.gob.sin.sre.fac.frvcc.misfacturas.libros.use.ports.primary.libros.seleccionar_compras.ILibroSeleccionarCompras;
...
@Service
public class LibroSeleccionarCompras  implements ILibroSeleccionarCompras {
	private static final Logger LOG= LoggerFactory.getLogger(LibroSeleccionarCompras.class);
   ...
   public LibroSeleccionarCompras(LibroRepository repository, EventBus eventBus,
                              GeneraNumeroOrdenRepository generaNumeroOrden,
    ...
    public void incrementarImporte(LibroId pLibroId,LibroUsuarioUltimaModificacion pUsuarioUltimaModificacion
       ...
       for (String idCompra : pListaIdsCompras) {
    	   ...
    	   try {
			...
			libro.incrementoImporte(compra.importeBaseCf(), compra.creditoFiscal(),
