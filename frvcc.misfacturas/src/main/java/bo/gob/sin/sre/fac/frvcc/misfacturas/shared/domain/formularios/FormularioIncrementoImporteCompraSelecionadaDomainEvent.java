...
public class FormularioIncrementoImporteCompraSelecionadaDomainEvent extends DomainEvent {
    ...
    public FormularioIncrementoImporteCompraSelecionadaDomainEvent() {
    ...
    public FormularioIncrementoImporteCompraSelecionadaDomainEvent(String aggregateId,
    ...
    public FormularioIncrementoImporteCompraSelecionadaDomainEvent(String aggregateId, String eventId,
                                                                   String occurredOn,
                                                                   BigDecimal totalCompras,
                                                                   Integer cantidadCompras,
                                                                   BigDecimal determinacionPago,
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new FormularioIncrementoImporteCompraSelecionadaDomainEvent(aggregateId, eventId, occurredOn,
