...
public final class CompraNotaAsociadaLibroDomainEvent extends DomainEvent {
    ...
    public CompraNotaAsociadaLibroDomainEvent(String aggregateId, String libroId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion,  BigDecimal importeTotalNota, BigDecimal creditoFiscalNota) {
        super(aggregateId);
    ...
    public CompraNotaAsociadaLibroDomainEvent(String aggregateId, String eventId, String occurredOn, String libroId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion, BigDecimal importeTotalNota, BigDecimal creditoFiscalNota) {
    ...
    public CompraNotaAsociadaLibroDomainEvent() {
        this.libroId = null;
    ...
    public String eventName() {
        return "compra.nota.asociada.libro";
    }
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new CompraNotaAsociadaLibroDomainEvent(
                aggregateId,
                eventId,
                occurredOn,
