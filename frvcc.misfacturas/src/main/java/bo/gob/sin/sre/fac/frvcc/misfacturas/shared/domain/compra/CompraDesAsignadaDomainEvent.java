...
public final class CompraDesAsignadaDomainEvent extends DomainEvent {
    ...
    public CompraDesAsignadaDomainEvent(String aggregateId, String formularioId, String estadoUsoId, Integer periodoUso, Integer gestionUso, String impuestoUsoId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion, String nombreFormularioUso, BigDecimal importeBaseCf, BigDecimal creditoFiscal
    ...
    public CompraDesAsignadaDomainEvent(String aggregateId, String eventId, String occurredOn, String formularioId, String estadoUsoId, Integer periodoUso, Integer gestionUso, String impuestoUsoId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion, String nombreFormularioUso, BigDecimal importeBaseCf, BigDecimal creditoFiscal
    		,BigDecimal importeTotalCompra,String marcaEspecialId,String modalidadId) {
    ...
    public CompraDesAsignadaDomainEvent() {
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new CompraDesAsignadaDomainEvent(
                aggregateId,
                eventId,
                occurredOn,
