...
public  class FormularioDecrementadoImporteDomainEvent extends DomainEvent {
    ...
    public FormularioDecrementadoImporteDomainEvent() {
        this.compras = null;
    ...
    public FormularioDecrementadoImporteDomainEvent(String aggregateId,
    ...
    public FormularioDecrementadoImporteDomainEvent(String aggregateId, String eventId,
    ...
    public String eventName() {
        return "formulario.decrementar_importe";
    }
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new FormularioDecrementadoImporteDomainEvent(aggregateId, eventId, occurredOn,
