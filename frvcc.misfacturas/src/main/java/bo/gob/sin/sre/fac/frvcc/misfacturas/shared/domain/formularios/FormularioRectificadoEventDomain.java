...
public final class FormularioRectificadoEventDomain extends DomainEvent {
    ...
    public FormularioRectificadoEventDomain() {
        this.comprasId = null;
    ...
    public FormularioRectificadoEventDomain(String aggregateId,
                                          Long numeroOrden,
    ...
    public FormularioRectificadoEventDomain(String aggregateId, String eventId, String occurredOn,
                                          Long numeroOrden,
                                          String estadoFormularioId,
                                          LocalDate fechaPresentacion,
                                          BigDecimal determinacionPago,
    ...
    public String eventName() {
        return "formularios.rectificado";
    }
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new FormularioRectificadoEventDomain(
                aggregateId,
                eventId,
                occurredOn,
