...
public final class CompraAsociadaLibroDomainEvent extends DomainEvent {
    ...
    public CompraAsociadaLibroDomainEvent(String aggregateId, String libroId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion,
    ...
    public CompraAsociadaLibroDomainEvent(String aggregateId, String eventId, String occurredOn, String libroId, Long usuarioUltimaModificacion, LocalDateTime fechaUltimaModificacion,
    		String estadoUsoId, Integer periodoUso, Integer gestionUso, String impuestoUsoId,String nombreFormularioUso,
    ...
    public CompraAsociadaLibroDomainEvent() {
        this.libroId = null;
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new CompraAsociadaLibroDomainEvent(
                aggregateId,
                eventId,
                occurredOn,
