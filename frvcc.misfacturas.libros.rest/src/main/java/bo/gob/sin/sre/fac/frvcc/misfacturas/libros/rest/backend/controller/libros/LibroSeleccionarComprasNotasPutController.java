...
import bo.gob.sin.sre.fac.frvcc.misfacturas.libros.adapters.primary.libros.seleccionar_compras_notas.SeleccionarComprasNotasLibroCommand;
...
public class LibroSeleccionarComprasNotasPutController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public LibroSeleccionarComprasNotasPutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
        // TODO Auto-generated constructor stub
    }

    @PutMapping(value = "/libro/seleccionarComprasNotas/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id,
        ...
        dispatch(new SeleccionarComprasNotasLibroCommand(id,usuarioId(),request.listaIdsCompras()));
