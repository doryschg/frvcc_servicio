...
public class LibroDeclararPutController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public LibroDeclararPutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
        // TODO Auto-generated constructor stub
    }

    @PutMapping(value = "/libro/declarar/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id,
        ...
        dispatch(new DeclararLibroCommand(id,request.codAdmin(),usuarioId()));
