...
public class LibroSeleccionarComprasPutController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public LibroSeleccionarComprasPutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
        // TODO Auto-generated constructor stub
    }

    @PutMapping(value = "/libro/seleccionarCompras/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id,
        ...
        dispatch(new SeleccionarComprasLibroCommand(id,usuarioId(),request.listaIdsCompras()));
