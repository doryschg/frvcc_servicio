...
import bo.gob.sin.sre.fac.frvcc.misfacturas.libros.adapters.primary.libros.desmarcar_compras_notas.DesmarcarComprasNotasLibroCommand;
...
public class LibroDesmarcarComprasNotasPutController extends ApiController {
	@Autowired
	private IMensajeAplicacionDomain mensajesDomain;
    public LibroDesmarcarComprasNotasPutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
        // TODO Auto-generated constructor stub
    }

    @PutMapping(value = "/libro/desmarcarComprasNotas/{id}")
    public ResponseEntity<ResultadoGenericoDto<String>> index(@PathVariable String id,
        ...
        dispatch(new DesmarcarComprasNotasLibroCommand(id,usuarioId(),request.listaIdsCompras()));
