...
public class SearchVentasByCriteriaQuery implements Query {
	...
	public SearchVentasByCriteriaQuery(List<HashMap<String, String>> filters, Optional<String> orderBy,
