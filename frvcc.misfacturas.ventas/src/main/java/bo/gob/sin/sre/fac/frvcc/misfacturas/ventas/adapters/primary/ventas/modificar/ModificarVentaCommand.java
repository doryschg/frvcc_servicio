...
public class ModificarVentaCommand implements Command {
	...
	private ModificarVentaCommand(Builder builder) {
	...
	public static Builder newModificarVentaCommand() {
		return new Builder();
	}
	...
	public static final class Builder {
		...
		public ModificarVentaCommand build() {
			return new ModificarVentaCommand(this);
		}
