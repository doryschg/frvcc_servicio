package bo.gob.sin.sre.fac.frvcc.misfacturas.ventas.use.ports.primary.ventas.modificar;
...
public interface IVentaModificar {
	void modificar(VentaId pId, VentaRecepcionId pRecepcionId, VentaIfcProveedor pIfcProveedor,
			...
			VentaImporteBase pImporteBase, VentaOrigenId pOrigenId, VentaUsuarioUltimaModificacion pUsuarioUltimaModificacion,
